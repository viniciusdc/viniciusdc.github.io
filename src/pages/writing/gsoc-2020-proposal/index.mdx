---
title: GSoC 2020 — final proposal
date: 2020-03-25
tag: archive
description: My original Google Summer of Code 2020 proposal to conda-forge, preserved as-is. An undergraduate writing about what he wants to spend a summer building.
---

{/* cspell:words espectral comunitys potiencil inciate worksetup fase coda enviroment examplesm Oficial Dynamodb */}

*Original GSoC 2020 final proposal, written March 2020. Preserved verbatim — typos and 4th-year-undergrad voice intact. The work it proposes is summarized in the [conda-forge auto-tick bot project page](/projects/conda-forge-autotick-bot/).*
...
GitHub: [https://github.com/viniciusdc](https://github.com/viniciusdc)

Linkedin: [https://www.linkedin.com/in/vinicius-douglas-530202142/](https://www.linkedin.com/in/vinicius-douglas-530202142/)
...
- Created a blog, in Github, for communication and content share [https://viniciusdc.github.io/](https://viniciusdc.github.io/)
...
- The goal for this fase, is to finish the code that writes the new versions to a separate data structure outside the graph environment. Which can be seen on the issues page of conda-forge `cf-script` page on GitHub [pull#907](https://github.com/regro/cf-scripts/pull/907), or on my blog.
