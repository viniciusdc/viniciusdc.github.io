...
The main issue for the project and the general discussion can be inspected here [2](https://github.com/regro/cf-scripts/issues/842).
   ...
   - As a matter of fact, we could also insert new utilities insethe the update_upstream_versions code to solve some issues [8](https://github.com/regro/cf-scripts/pull/1073);
   - Finally we could proceed and switch the old update upstream version code with the new one, and set the new process to work altogether with the main bot processes [9](https://github.com/regro/cf-scripts/pull/1075), as also CJ helped me solving some bugs and other issues with the code [10](https://github.com/regro/cf-scripts/pull/1099).
